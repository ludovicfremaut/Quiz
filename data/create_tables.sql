...
-- Convention 2 : chaque table contiendra un champs 'created_at' contenant la date de création d'un enregistrement et un champ 'updated_at' contenant la date de mise à jour de cet enregistrement.
...
- Ici le fait de ne spécifier que REFERENCES va amener prostgreSQL à créer une contrainte de clé étrangère automatiquement en lui fournissant le nom automatiquement CONSTRAINT "user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id")
*/
